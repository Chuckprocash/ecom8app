        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                    <tr>
                        <th scope="col" class="px-4 py-3 w-auto">Brand name</th>
                        <th class="w-32 px-4 py-3 cursor-pointer hover:bg-gray-500" @click="boxOpen">Add Brand</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr v-for="brand in brands" class="border-b border-b-slate-700">
                        <td class="px-4 py-3 w-auto">{{ brand.name }}</td>
                        <td class="w-32">edit/delete</td>
                    </tr>
                </tbody>
            </table>
        </div>
