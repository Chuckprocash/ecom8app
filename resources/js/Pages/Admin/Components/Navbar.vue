      ...
      <div class="flex flex-wrap justify-between items-center">
        <div class="flex justify-start items-center">
          ...
          <Link :href="route('admin.dashboard')" class="flex items-center justify-between mr-4">
            <img
              src="/images/shopping-bag-ecom-app.svg"
              class="mr-3 h-8"
              alt="Shopping Logo"
            />
            <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Ecom-App</span>
          </Link>
            ...
            >
              <li>
                <Link
                  ...
                  method="post"
                  class="block py-2 px-4 text-sm hover:bg-gray-100 rounded-xl dark:hover:bg-gray-600 dark:hover:text-white"
                  >Sign out</Link
                >
              </li>
            </ul>
