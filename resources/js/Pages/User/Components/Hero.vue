...
<div class="relative isolate px-6 py-10 lg:px-8">
    ...
    <div class="mx-auto max-w-2xl">
      ...
      <div class="text-center">
        <h1 class="text-xl font-semibold tracking-tight text-balance text-white sm:text-6xl">Data to enrich your online business</h1>
    ...
    <div aria-hidden="true" class="absolute inset-x-0 top-[calc(100%-13rem)] -z-10 overflow-hidden blur-3xl sm:top-[calc(100%-30rem)]">
